<?php
$lang['PaypalPaymentsUniversal.name'] = "PayPal";
...
$lang['PaypalPaymentsUniversal.!error.default_currency.changed'] = "Your Selected Currency [%1\$s] is not Accepted in this gateway , So we wll procced the payment with this currency [%2\$s] .";
?>